<nav class="bg-gray-800" x-data='{ open: false}'>
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <div class="relative ml-3" x-data="{ open: false }">
                        ...
                        <div x-show="open"
                            ...
                            @can('admin.home')
                                <a href="{{ route('admin.home')}}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Dasboard</a> 
                            @endcan
    ...
    <div class="sm:hidden" x-show='open' x-on:click.away="open = false" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            @foreach ($categories as $category)
            <a href="{{ route('posts.category', $category) }}" class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium"
